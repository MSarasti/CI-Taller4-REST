...
public class Product implements Serializable {
	...
	@NotNull(groups={addValidation.class, updateValidation.class}, message="Days to manufacture cannot be blank")
	@Digits(groups={addValidation.class, updateValidation.class}, message="Days to manufacture must be an integer", fraction = 0, integer = 1000)
	@Min(groups={addValidation.class, updateValidation.class}, message="Days to manufacture must be greater than 0", value = 1)
	...
	@NotBlank(groups={addValidation.class, updateValidation.class}, message="Name cannot be blank")
	@Size(min=3, groups={addValidation.class, updateValidation.class}, message="Name must be 3 characters or longer")
	private String name;

	private String productline;

	@NotBlank(groups={addValidation.class, updateValidation.class}, message="Product number cannot be blank")
	@Min(groups={addValidation.class, updateValidation.class}, message="Product number must be greater than 0", value = 1)
	...
	@NotNull(groups={addValidation.class, updateValidation.class}, message="Sell end date cannot be blank")
	@Future(groups={addValidation.class, updateValidation.class}, message="Sell end date must be a future date")
	private LocalDate sellenddate;
	
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@NotNull(groups={addValidation.class, updateValidation.class}, message="Sell start date cannot be blank")
	@FutureOrPresent(groups={addValidation.class, updateValidation.class}, message="Sell start date must be in the present or future")
	...
	//@NotNull(groups={addValidation.class, updateValidation.class}, message="Product subcategory cannot be null")
	private Productsubcategory productsubcategory;

	// bi-directional many-to-one association to Unitmeasure
	@ManyToOne
	@JoinColumn(name = "sizeunitmeasurecode")
	//@NotNull(groups={addValidation.class, updateValidation.class}, message="Unit measure cannot be null")
	...
	@Transient
	public Integer pcatId;
	
	@Transient
	public Integer psubId;
	
	@Transient
	public Integer um1Id;

	@Transient
	public Integer um2Id;
	
	@Transient
	public boolean isBeforeOrEqual;
	...
	public Integer getPsubId() {
		return psubId;
	}

	public void setPsubId(Integer psubId) {
		this.psubId = psubId;
	}

	public Integer getUm1Id() {
		return um1Id;
	}

	public void setUm1Id(Integer umId) {
		this.um1Id = umId;
	}
	
	public Integer getUm2Id() {
		return um2Id;
	}

	public void setUm2Id(Integer umId) {
		this.um2Id = umId;
	}
	
	@AssertTrue(groups={addValidation.class, updateValidation.class}, message="The sell start date must be before sell end date.")
	public boolean isBeforeEnd() {
		return sellstartdate.isBefore(sellenddate) || sellstartdate.isEqual(sellenddate);
	}
}